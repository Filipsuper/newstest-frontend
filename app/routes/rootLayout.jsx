    ...
    return (
        <main className="min-h-screen bg-gradient-to-tr relative ">
            <header className=" w-full px-10 py-2 flex flex-col md:flex-row justify-between items-center space-x-2 relative z-10 bg-foreground border-b border-border mb-8">
                ...
                <span className="text-text-muted"><span className="text-secondary">Nytt:</span> Skannar 60% fler artiklar samt ny filter implementering. ( Bättre innehåll till summeringen )  Mailutskick börjar på måndag.</span>
            </header>
            <Outlet />
