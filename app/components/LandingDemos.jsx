        ...
        <div className={`${card} p-6`} aria-hidden="true">
            ...
            <div className="flex flex-col gap-1.5 mb-4">
                {[
                    ...
                    <div key={idx} className="flex items-center gap-2 bg-bullet text-bullet-text rounded-full px-3 py-1 text-xs font-bold font-serif w-fit">
                        <svg className="w-1.5 h-1.5 fill-current shrink-0" viewBox="0 0 8 8"><circle cx="4" cy="4" r="4" /></svg>
                        {line}
                    </div>
                ))}
            </div>
